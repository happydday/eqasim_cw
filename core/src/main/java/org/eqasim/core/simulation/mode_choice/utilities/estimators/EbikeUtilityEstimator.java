...
import org.eqasim.core.simulation.mode_choice.utilities.predictors.EbikePredictor;//changed to Ebike predictor
...
public class EbikeUtilityEstimator implements UtilityEstimator {
	private final ModeParameters parameters;
	private final EbikePredictor bikePredictor;
	private final PersonPredictor personPredictor;

	@Inject
	public EbikeUtilityEstimator(ModeParameters parameters, PersonPredictor personPredictor,
			EbikePredictor bikePredictor) {
	...
	public EbikePredictor getBikePredictor() {
